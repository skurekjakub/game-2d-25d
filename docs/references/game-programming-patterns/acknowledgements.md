> **Source:** [https://gameprogrammingpatterns.com/acknowledgements.html](https://gameprogrammingpatterns.com/acknowledgements.html)
...
<span id="editor">About</span> halfway through writing, I decided to forgo a traditional publisher. I knew that meant losing the guidance an editor brings, but I had email from dozens of readers telling me where they wanted the book to go. I’d lose proofreaders, but I had over <span id="colm">250 bug reports</span> to help improve the prose. I’d give up the incentive of a writing schedule, but with readers patting my back when I finished each chapter, I had more than enough motivation.
...
← [Previous<span class="full-nav"> Chapter</span>](contents.html)
...
[Next<span class="full-nav"> Chapter</span>](introduction.html) →
